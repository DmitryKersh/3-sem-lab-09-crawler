...
TEST(url_reader, parse_url) {
    ...
    EXPECT_EQ(std::make_optional(std::make_pair(std::string("github.com"), std::string("/"))), parse_url("github.com"));
    EXPECT_EQ(std::make_optional(::std::make_pair(std::string("example.com"), std::string("/foo/bar/baz"))),
...
TEST(parser, parse_http_response) {
    EXPECT_EQ((ParsingResult{{}, {"example.com"}}),
              parse_response(ok_http_response_("<html><a href='example.com'/></html>"), true));
    EXPECT_EQ((ParsingResult{{}, {}}),
              parse_response(ok_http_response_("<html><a href='example.com'/></html>"), false));

    EXPECT_EQ((ParsingResult{{}, {"example.com"}}),
              parse_response(ok_http_response_("<html><b><i><a href='example.com'/></i></b></html>"), true));
    EXPECT_EQ((ParsingResult{{}, {}}),
              parse_response(ok_http_response_("<html><b><i><a href='example.com'/></i></b></html>"), false));
    EXPECT_EQ((ParsingResult{{"picture.png"}, {}}),
              parse_response(ok_http_response_("<html><img src='picture.png'></html>"), true));
    EXPECT_EQ((ParsingResult{{"picture.png"}, {}}),
              parse_response(ok_http_response_("<html><img src='picture.png'></html>"), false));
    ...
    EXPECT_EQ((ParsingResult{{"beautiful.png"}, {"progrm-jarvis.ru"}}),
              parse_response(ok_http_response_("<html>"
                                               ...
                                               "</html>"),
                             true));
    EXPECT_EQ((ParsingResult{{"beautiful.png"}, {}}), parse_response(ok_http_response_("<html>"
                                                                                       "<a href='progrm-jarvis.ru'/>"
                                                                                       "<img src='beautiful.png'>"
                                                                                       "</html>"),
                                                                     false));
