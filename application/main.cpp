...
static program_options::options_description create_description_() noexcept {
    ...
    description.add_options()("help,h", "Shows this help message")(
        "url,u", value<::std::string>(), "HTML page address")("depth,d", value<::std::size_t>()->default_value(0),
                                                              "Page search depth")(
...
program_options::variables_map parse_program_options(int const arguments_count, const char* const arguments[]) {
    ...
    program_options::store(program_options::parse_command_line(arguments_count, arguments, DESCRIPTION), variables);
    variables.notify();
